...
VALID_COLUMNS_NACIMIENTOS = ["ano",     "area_res",     "areanac",     "aten_par",     "cod_dpto",     "cod_munic",     "codmunre",     "codpres",     "codptore",     "edad_madre",     "edad_padre",     "est_civm",     "idclasadmi",     "idfactorrh",     "idhemoclas",     "mes",     "mul_parto",     "niv_edum",     "niv_edup",     "numconsul",     "peso_nac",     "profesion",     "seg_social",     "sexo",     "sit_parto",     "t_ges",     "talla_nac",     "tipo_parto",
                             ]

VALID_COLUMNS_FETALES = ["a_defun",     "ano",     "area_res",     "asis_med",     "cau_homol",     "cod_dpto",     "cod_munic",     "codmunre",     "codptore",     "edad_madre",     "est_civm",     "mes",     "mu_parto",     "n_hijosm",     "n_hijosv",     "niv_edum",     "peso_nac",     "sexo",     "sit_defun",     "t_ges",     "t_parto",     "tipo_defun",     "tipo_emb",
                         ]
